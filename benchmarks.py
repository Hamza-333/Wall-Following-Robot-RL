...
plt.figure(figsize=(10, 5))
plt.plot(ppo_monitor_df['r'][:49], label='PPO')  
plt.plot(sac_monitor_df['r'][:49], label='SAC')  
plt.plot(ddpg_monitor_df['r'][:49], label='DDPG') 
plt.plot(td3_df['r'], label='TD3')
plt.xlabel('Episodes')
plt.ylabel('Episode Reward')
plt.title('Learning Curves: Rewards vs Episodes')
...
plt.figure(figsize=(10, 5))
plt.plot(ppo_monitor_df['l'][:49], label='PPO') 
plt.plot(sac_monitor_df['l'][:49], label='SAC')  
plt.plot(ddpg_monitor_df['l'][:49], label='DDPG')  
plt.plot(td3_df['l'], label='TD3')
plt.xlabel('Episodes')
plt.ylabel('Episode length')
plt.title('Learning Curves: Episode len vs Episodes')
...
plt.figure(figsize=(10, 5))
plt.plot(ppo_monitor_df['l'][:49] + ppo_monitor_df['r'][:49], label='PPO')  
plt.plot(sac_monitor_df['l'][:49] + sac_monitor_df['r'][:49], label='SAC')  
plt.plot(ddpg_monitor_df['l'][:49] + ddpg_monitor_df['r'][:49], label='DDPG') 
plt.plot(td3_df['l'][:49] + td3_df['r'][:49], label='TD3')
plt.xlabel('Episodes')
plt.ylabel('Episode len + Rewards')
plt.title('Learning Curves: Episode len + Rewards vs Episodes')
plt.xticks(rotation=90)  # Rotate the y-axis labels by 45 degrees
